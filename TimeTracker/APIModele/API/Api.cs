...
using TimeTracker.APIModel.API.Projects;
...
namespace TimeTracker.APIModel.API
{
    public class Api
    {
        ...
        public async Task<Response<UserProfileResponseTest>> getmeAsync(string access_token)
        {
            var client = new HttpClient();
            client.BaseAddress = new Uri(Urls.API);
            client.DefaultRequestHeaders.Add("Authorization", "Bearer " + access_token);
            ...
            var result = await response.Content.ReadAsStringAsync();
            Response<UserProfileResponseTest> test = JsonConvert.DeserializeObject<Response<UserProfileResponseTest>>(result);
        ...
        public async Task<Response<UserProfileResponseTest>> modifmeAsync(string access_token, string mail, string first_name, string last_name)
        {
            var client = new HttpClient();
            client.BaseAddress = new Uri(Urls.API);
            client.DefaultRequestHeaders.Add("Authorization", "Bearer " + access_token);

            UserProfileResponseTest infome = new UserProfileResponseTest();
